...
Data::wireEncode(EncodingImpl<TAG>& encoder, bool wantUnsignedPortionOnly) const
{
  ...
  //fww 10-14
    totalLength += prependNonNegativeIntegerBlock(encoder,tlv::Betw,getBetw());
  //
...
Data::wireDecode(const Block& wire)
{
  ...
  //介数，修改在此处
  /////////////////////////////////////////////
  val = m_wire.find(tlv::Betw);
  if (val != m_wire.elements_end()) {
    m_betw = readNonNegativeInteger(*val);
  }
  /////////////////////////////////////////////
}
////////////////////////////////////
